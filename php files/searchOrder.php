...
$stat="select * from orders where orderID LIKE '%$value%' OR food LIKE '%$value%' OR quantity LIKE '%$value%' OR specification LIKE '%$value%' OR amount LIKE '%$value%' ";
...
?>
   <tr><td colspan="5" align="center" style="background-color: lightblue;"><button style="height: 30px; width: 200px; background-color: darkblue; color: white;"><a href="viewOrders.php">  Back</button></td></tr>
